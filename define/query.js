...
},
{
    ...
    query : ['szUserName', 'szRealName', 'szMail', 'szLiensePlate', 'szAddress', 'szModels', 'szBankCard', 'szBankAddress', 'szAlipay', 'szAlipayNickname'],
    queryType :['string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string'], 
    access : 1,
    limit : 500,
    comment : '用户完善资料接口'
    //成功 {'errCode':0, 'msg':'success'}
